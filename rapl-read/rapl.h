...
static int rapl_total_packages=0, rapl_cpu_model, rapl_package_map[RAPL_MAX_PACKAGES];
static unsigned int msr_rapl_units,msr_pkg_energy_status,msr_pp0_energy_status;
static int rapl_dram_avail=0,rapl_pp0_avail=0;
static double rapl_power_units,rapl_time_units;
static double rapl_cpu_energy_units[RAPL_MAX_PACKAGES],rapl_dram_energy_units[RAPL_MAX_PACKAGES];
static double rapl_package_before[RAPL_MAX_PACKAGES],rapl_package_after[RAPL_MAX_PACKAGES];
static double rapl_pp0_before[RAPL_MAX_PACKAGES],rapl_pp0_after[RAPL_MAX_PACKAGES];
static double rapl_dram_before[RAPL_MAX_PACKAGES],rapl_dram_after[RAPL_MAX_PACKAGES];

static int rapl_open_msr(int core) {
...
static long long rapl_read_msr(int fd, unsigned int which) {
